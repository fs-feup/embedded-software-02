...
constexpr std::array<uint8_t, 3> BTB_READY_SEQUENCE = {BTB_READY_1, BTB_READY_2, BTB_READY_3};// {BTB_READY_1, BTB_READY_2, BTB_READY_3}
constexpr std::array<uint8_t, 3> ENABLE_SEQUENCE = {ENABLE_1, ENABLE_2, ENABLE_3};// {ENABLE_1, ENABLE_2, ENABLE_3}
